...
public class ReadFrag extends Fragment implements ReadRecyclerAdapter.ItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (RecipientID != null && !RecipientID.equals("") && viewToPresenter != null) {
            viewToPresenter.retrieveReadLetters(RecipientID);
        }
    ...
    public void passLetters(ArrayList<Model.Letter> readLetters) {


        adapter = new ReadRecyclerAdapter(this, context, readLetters);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(context));
        recyclerView.setAdapter(adapter);

        viewToPresenter.ReadLetterShownSuccess();
    }
